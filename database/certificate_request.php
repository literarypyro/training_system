	...
	if(document.getElementById('trainingPageNumber').value==""){
		...
		if(action=="prev"){
			...
			if((pgindex==1)||(pgindex=="")){
				...
				diplomaCount=trainees[currentRecord][pgindex*1-1]['diploma_count'];
				if(diplomaCount>0){
			...
			if((trainees[currentRecord].length*1-1)==0){
				...
				document.getElementById('issuanceType').length=0;
				diplomaCount=trainees[currentRecord][pgindex*1]['diploma_count'];
				if(diplomaCount>0){
					document.getElementById('issuanceType').options[0]=new Option("Re-Issuance","Re-Issuance");
				}
				else {
...
<form action="training_cert.php?a=cr&action=add" method="post">

	<table id='indexhere' align=center style='border: 1px solid gray' width=600>
	<th style="vertical-align:center;background-color:#ed5214;color:white;" colspan=3 ><h1>Request for Certification</h1>
	</th>
	</table>
...
<br>
	<table id='dynamicProgram' width=400 align=center style='border: 1px solid gray'>
		...
		<tr>
			...
			<input id='traineePageNumber' style="text-align:center" type="text" name="pageNumber" size=4 value='' onkeyup="iterateTrainee(document.getElementById('traineePageNumber').value,'index');" />	
	...
	<table id='dynamicProgram' width=400 align=center style='border: 1px solid gray'>
		<tr><th style="background-color: #00cc66;color: white;"	colspan=2>Date of Certificate Request:</th></tr>
...
?>	
	...
	<table id='dynamicProgram' width=400 align=center style='border: 1px solid gray'>
		<tr><th style="background-color: #00cc66;color: white;"	colspan=2>Type of Issuance:</th></tr>
		<tr>
		<td valign=center style="background-color:white; color:black;" align=center>Additional Remarks:
		</td>
	...
	<tr><td align=center><input type=submit value='Process Request' /></td></tr>	
	</table>
</form>