...
<form action="training_evaluation.php?a=prt" method="post">
<table width=100%>
<tr>
<td align=center colspan=2>

	<table id='indexhere' align=center style='border: 1px solid gray' width=600>
	<th style="vertical-align:center;background-color:#ed5214;color:white;" colspan=3 ><h1>Printout Grading Form</h1>
	</th>
	</table>
<?php
if(isset($_GET['print'])){
	require("generate_evaluation_form.php");
...
<table align=center>	
	...
	<input type=submit value='Encode Grades' />
	</td>
	</tr>
</table>
</td>
