...
{
	$objReader = PHPPowerPoint_IOFactory::createReader('PowerPoint2007');
	// $objReader->setReadDataOnly(true);

	$objPHPPowerPoint = $objReader->load($presentationName);
...
{
	$objWriter = PHPExcel_IOFactory::createWriter($powerPointAPI, 'PowerPoint2007');
